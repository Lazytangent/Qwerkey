...
class TestAuthFunctionality:
    def test_valid_login(self, client):
        User.create(
            username="johnthetester", email="john@test.com", password="password"
        )
        ...
        response = client.post(
            "/api/auth/login",
            json={"credential": "johnthetester", "password": "password"},
        )
    ...
    def text_invalid_login(self, client):
        User.create(
            username="johnthetester", email="john@test.com", password="password"
        )
        ...
        response = client.post(
            "/api/auth/login",
            json={"credential": "johnthetester", "password": "bad password"},
